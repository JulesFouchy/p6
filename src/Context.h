...
class Context;
class [[nodiscard("You need to assign this to a variable. It will push_transform() when created and pop_transform() when it goes out of scope. See https://julesfouchy.github.io/p6-docs/tutorials/transform#transform_scope_guard")]] TransformScopeGuard // NOLINT(*-special-member-functions)
{
public:
